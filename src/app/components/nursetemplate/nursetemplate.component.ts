...
@Component({
  selector: 'app-nursetemplate',
  templateUrl: './nursetemplate.component.html',
  styleUrls: ['./nursetemplate.component.css']
})
export class NursetemplateComponent implements OnInit {
