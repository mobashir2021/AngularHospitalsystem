...
@Component({
  selector: 'app-sofaanalysis',
  templateUrl: './sofaanalysis.component.html',
  styleUrls: ['./sofaanalysis.component.css']
})
export class SofaanalysisComponent implements OnInit {
  ...
  constructor(private dialogRef : MatDialogRef<SofaanalysisComponent>) { 
    this.chartOptions = {
      series: [
        {
          name: "Protein",
